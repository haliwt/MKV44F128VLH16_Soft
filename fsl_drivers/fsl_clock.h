 ...
 */
#if !(defined(FSL_SDK_DISABLE_DRIVER_CLOCK_CONTROL)) // #ifndef NAME
...
#define SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY (168000000UL)
#endif
...
#define FTM_CLOCKS                                              \
    {                                                           \
        kCLOCK_Ftm0, kCLOCK_Ftm1, kCLOCK_IpInvalid, kCLOCK_Ftm3 \
    }
...
typedef enum _clock_ip_name
{
    ...
    kCLOCK_PortD  = CLK_GATE_DEFINE(0x1038U, 12U),  //offset 0x1038u
    ...
    kCLOCK_Adc0   = CLK_GATE_DEFINE(0x1038U, 28U),
...
{
    SIM->CLKDIV1 = 0x01370000U;
    /* bus_flash div = 8, core_system div = 1, fast_peripheral div = 2 */
}
