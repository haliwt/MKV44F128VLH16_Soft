...
/******************************************************************/
 /**
 * @brief  璁剧疆寮曡剼涓鸿緭鍏ヨ繕鏄緭鍑哄姛鑳? 鐢ㄦ埛涓�鑸笉蹇呰皟鐢? * @note   鍙湁褰撳紩鑴氫綔涓篏PIO鏃舵墠鏈夋剰涔? * @code
 *      // 灏哖ORTB绔彛鐨?寮曡剼璁剧疆杈撳叆寮曡剼
 *      GPIO_PinConfig(HW_GPIOB, 3, kInpput);
 * @endcode
 * @param[in]  instance GPIO妯″潡鍙? *              @arg HW_GPIOA 鑺墖鐨凱ORTA绔彛
 *              @arg HW_GPIOB 鑺墖鐨凱ORTB绔彛
 *              @arg HW_GPIOC 鑺墖鐨凱ORTC绔彛
 *              @arg HW_GPIOD 鑺墖鐨凱ORTD绔彛
 *              @arg HW_GPIOE 鑺墖鐨凱ORTE绔彛
 * @param[in]  pin  绔彛涓婄殑寮曡剼鍙?0~31
 * @param[in]  mode 杈撳叆鎴栬�呰緭鍑鸿缃? *              @arg kInpput  杈撳叆鍔熻兘閫夋嫨
 *              @arg kOutput  杈撳嚭鍔熻兘閫夋嫨
 * @retval None
 */
 ...
 * @param[in]  instance GPIO妯″潡鍙? *              @arg HW_GPIOx  GPIOx moudle
